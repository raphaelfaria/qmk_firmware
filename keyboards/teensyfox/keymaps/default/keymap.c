...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  /* Layer 0: Default Layer
    ...
    * |---------------------------------------------------------------|
    * |Ctrl|Gui |Alt |         Space        |Gui |Alt |   |Lef|Dow|Rig|
    * `---------------------------------------------------------------'
    */
  [0] = LAYOUT( \
  ...
  [1] = LAYOUT( \
      ...
      KC_TRNS,           KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_END, KC_PGDN,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,         KC_VOLU, KC_TRNS,\
      MO(2),    KC_TRNS, KC_TRNS,                KC_MPLY,                        KC_TRNS,KC_TRNS,                 KC_MPRV, KC_VOLD, KC_MNXT \
  ),
